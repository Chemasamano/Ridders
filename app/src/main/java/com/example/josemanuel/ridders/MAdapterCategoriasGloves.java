 ...
 */
public class MAdapterCategoriasGloves extends ArrayAdapter<Gloves> {
    private Context mContext;
    private List<Gloves> mTasks;
    ...
    public MAdapterCategoriasGloves(Context context, List<Gloves> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        Gloves task = mTasks.get(position);
