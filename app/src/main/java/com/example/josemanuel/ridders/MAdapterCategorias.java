 ...
 */
public class MAdapterCategorias extends ArrayAdapter<Backpacks> {
    private Context mContext;
    private List<Backpacks> mTasks;
    ...
    public MAdapterCategorias(Context context, List<Backpacks> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        Backpacks task = mTasks.get(position);
