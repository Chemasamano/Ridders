 ...
 */
public class MAdapterCategoriasProtection extends ArrayAdapter<Protection> {
    private Context mContext;
    private List<Protection> mTasks;
    ...
    public MAdapterCategoriasProtection(Context context, List<Protection> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        Protection task = mTasks.get(position);
