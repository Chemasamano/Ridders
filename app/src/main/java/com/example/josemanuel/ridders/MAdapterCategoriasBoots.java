 ...
 */
public class MAdapterCategoriasBoots extends ArrayAdapter<Boots> {
    private Context mContext;
    private List<Boots> mTasks;
    ...
    public MAdapterCategoriasBoots(Context context, List<Boots> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        Boots task = mTasks.get(position);
