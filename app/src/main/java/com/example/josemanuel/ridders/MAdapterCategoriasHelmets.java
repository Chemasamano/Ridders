 ...
 */
public class MAdapterCategoriasHelmets extends ArrayAdapter<Helmets> {
    private Context mContext;
    private List<Helmets> mTasks;
    ...
    public MAdapterCategoriasHelmets(Context context, List<Helmets> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        Helmets task = mTasks.get(position);
