 ...
 */
public class MAdapterCategoriasJackets extends ArrayAdapter<Jackets> {
    private Context mContext;
    private List<Jackets> mTasks;
    ...
    public MAdapterCategoriasJackets(Context context, List<Jackets> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        Jackets task = mTasks.get(position);
